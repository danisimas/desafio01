...
def criar_usuario():
    ...
    id_usuario=0
    try:
        id_usuario = criar_usuario(usuario_json)
        sucesso = True
...
def atualizar_usuario():
    ...
    try:
        if existe_usuario(id) == True:
            atualizar_usuario(usuario_json)
            sucesso = True
...
def obter_usuario_id(id):
    ...
    sucesso = False
    if existe_usuario(id) == True:
        usuario_id = obter_usuario_id(id)
        sucesso = True
...
def criar_produto():
    ...
    id_produto=0
    try:
        id_produto = criar_produto(produto_json)
        sucesso = True
...
def atualizar_preco_dolar_produto():
    ...
    try:
        if existe_produto(id) == True:
            atualizar_preco_dolar(novo_preco_dolar_json)
            sucesso = True
